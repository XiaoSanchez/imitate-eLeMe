...
export default class MyWebView extends Component {
    ...
    render() {
        return ( <
            ...
            <
            WebView style = {
                [styles.webview_style, this.props.style] } {...this.props }
            ...
            /WebView> <
            View style = {
                [styles.infoPage, this.state.error ? styles.showInfo : {}] } >
            <
            Text style = {
                { color: "#aaa" } } > { "加载失败" } < /Text> <
            /View> <
            Animated.View style = {
                [styles.progress, { width: this.state.progress }] } > < /Animated.View> <
            /View>
        )
    }
}
