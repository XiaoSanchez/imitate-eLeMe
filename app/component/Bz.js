                ...
                View style = { styles.actives } > {
                    activities.map((item, i) => {
                        return ( <
                            ...
                            style = {
                                { fontSize: px2dp(11), marginLeft: 3, color: "#666" } } > { item.text } < /Text> <
                            /View>
                        )
                    })
                } <
            ...
            return ( <
                    ...
                    View style = {
                        ...
                        isBrand ? ( < Text style = { styles.brand } > { "品牌" } < /Text>):null} <
                            ...
                            /View> <
                            View style = {
                                { flexDirection: "row", justifyContent: "flex-end", width: 70 } } > {
                                bao ? ( < Text style = { styles.label } > { "保" } < /Text>):null} {
                                        piao ? ( < Text style = {
                                                    [styles.label, { marginLeft: 2 }] } > { "票" } < /Text>):null} <
                                                /View> <
                                                /View> <
                                                View style = {
                                                    [styles.between, { marginTop: 8 }] } >
                                                <
                                                View style = {
                                                    { flexDirection: "row", flex: 1 } } >
                                                <
                                                ...
                                                /View> <
                                                Text style = {
                                                    { fontSize: px2dp(11), color: "#ff6000" } } > { scores } < /Text> <
                                                Text style = {
                                                    { fontSize: px2dp(11), color: "#666", marginLeft: 2 } } > { `月售${sale}单` } < /Text> <
                                                /View> <
                                                View style = {
                                                    { flexDirection: "row", justifyContent: "flex-end" } } > {
                                                    ontime ? ( < Text style = { styles.label1 } > { "准时达" } < /Text>):null} {
                                                            fengniao ? ( < Text style = {
                                                                    [styles.label2, { marginLeft: 2 }] } > { "蜂鸟专送" } < /Text>):null} <
                                                                /View> <
                                                                /View> <
                                                                View style = {
                                                                    [styles.between, { marginTop: 8 }] } >
                                                                ...
                                                                Text style = { styles.line } > { '|' } < /Text> <
                                                                Text style = {
                                                                    { fontSize: px2dp(11), color: "#00abff", marginLeft: 2 } } > { time } < /Text> <
                                                                /View> <
                                                                /View> { this.renderActivities() } <
                                                                /View> <
                                                                /View> <
                                                                /View> <
                                                                /Button>
